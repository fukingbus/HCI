...
$(function(){
	...
	parseProducts();
	$('#listCatPen').on('click',function(){
		$('#productList').html('');
		$('#productList').hide();
		appendProducts(products.sta.pen);
	});
	
	$('#listCatHLPen').on('click',function(){
		$('#productList').html('');
		$('#productList').hide();
		appendProducts(products.sta.highlightPen);
	});
	
	$('#listCatPencil').on('click',function(){
		$('#productList').html('');
		$('#productList').hide();
		appendProducts(products.sta.pencil);
	});
