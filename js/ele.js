...
$(function(){
	...
	$('#listCatApple').on('click',function(){
		$('#productList').html('');
		$('#productList').hide();
		appendProducts(products.ele.apple);
	});
	
	$('#listCatLenovo').on('click',function(){
		$('#productList').html('');
		$('#productList').hide();
		appendProducts(products.ele.lenovo);
	});
...
function concatAll(){
	ele =  products.ele;
	return ele.apple.concat(ele.lenovo);
}
